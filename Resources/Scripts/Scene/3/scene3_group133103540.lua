...
L2_1[2] = L4_1
suites = L2_1
function action_EVENT_GADGET_STATE_CHANGE_540006(A0_2, A1_2)
...
if A1_2.param2 == L1_1.gadget_light_1 or A1_2.param2 == L1_1.gadget_light_2 or A1_2.param2 == L1_1.gadget_light_3 then
	...
	elseif A1_2.param2 == L1_1.gadget_seal_id then
		...
		elseif A1_2.param1 == GadgetState.ChestLocked then
			...
			if L3_2%2 == 0 then
	            ...
	            if ScriptLib.GetGroupVariableValue(A0_2, "Puzzle_Flag_1") == 0 then
	                ScriptLib.SetGroupGadgetStateByConfigId(A0_2, L1_1.group_id, L1_1.gadget_light_1, GadgetState.GearStop)
	            end
			end
			if L3_2%4 < 2 then
	            ScriptLib.CreateGadget(A0_2, {config_id = L1_1.gadget_light_2})
	            if ScriptLib.GetGroupVariableValue(A0_2, "Puzzle_Flag_2") == 0 then
	                ScriptLib.SetGroupGadgetStateByConfigId(A0_2, L1_1.group_id, L1_1.gadget_light_2, GadgetState.GearStop)
	            end
			end
			if L3_2< 4 then
	            ScriptLib.CreateGadget(A0_2, {config_id = L1_1.gadget_light_3})
	            if ScriptLib.GetGroupVariableValue(A0_2, "Puzzle_Flag_3") == 0 then
	                ScriptLib.SetGroupGadgetStateByConfigId(A0_2, L1_1.group_id, L1_1.gadget_light_3, GadgetState.GearStop)
	            end
			end
		elseif A1_2.param1 == GadgetState.Action03 then
			...
			L2_2 = ScriptLib.GetGroupVariableValue(A0_2, "Temp_Point_Value")
			ScriptLib.SetGroupVariableValue(A0_2, "Point_Value", L2_2)
			ScriptLib.AddQuestProgress(A0_2, "7101102_progress")
	...
	if ScriptLib.GetGroupVariableValueByGroup(A0_2, "Unlocked", 133103496) == 0 then
	        ScriptLib.SetGroupVariableValueByGroup(A0_2, "Unlocked", 1, 133103496)
	end
		end
		return 0
	else
